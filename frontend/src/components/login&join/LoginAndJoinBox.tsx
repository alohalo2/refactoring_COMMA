...
import { LJ_Box, LJ_Box_First, LJ_Box_Logo_Image, LJ_Box_Second } from '../../css/LoginAndJoinBox.css';
    ...
    return (
        <div className={LJ_Box}>
            ...
            <div className={LJ_Box_Second}>
                <img className={LJ_Box_Logo_Image} src='/images/commaLogo.svg' alt="Comma Logo" />
                <h3>COMMA</h3>
